...
public class RuleEngineParameter {
    ...
    public RuleEngineParameter(String name, boolean skipOnFirstAppliedRule, boolean skipOnFirstUnAppliedRule, boolean skipOnFirstFailedRule, int priorityThreshold, boolean silentMode) {
        this.name = name;
